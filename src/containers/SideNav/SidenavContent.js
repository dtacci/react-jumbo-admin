        ...
        <ul className="nav-menu">
          ...
          <li className="menu collapse-box">
            ...
            <ul className="sub-menu">
              { // check flag boolean, if true, complete the expression
                flags.devTestFlag && 
                <li>
...
// const EnhancedComponent = compose(withRouter, withLDConsumer())(SidenavContent)

export default withRouter(withLDConsumer()(SidenavContent));
